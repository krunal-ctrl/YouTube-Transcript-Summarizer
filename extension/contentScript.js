...
chrome.extension.onMessage.addListener(function (msg, sender, sendResponse) {
  if (msg.action == "startLoadingWindow") {
    if (box == null) {
      ...
      sum_style.innerHTML =
        "#youtube-summarizer{overflow-y: scroll; margin-top: 20px;}";
    ...
    box.innerHTML += SENT_TIME_PAIR_ELEM.replace("{1}", json);
  }
});
